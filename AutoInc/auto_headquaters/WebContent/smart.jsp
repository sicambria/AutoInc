...
<head>
    ...
    <title>Product Details | Smart Car</title>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="images/home/products/smart_long.jpg" alt="" />
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h2>Smart</h2>
								<span>
									<span>US $15,000</span><br/>
									<span><h5>+3,500 for comfort edition</h5></span><br/>
								</span>
								
								<p><b>Engine:</b> 597cc</p>
								<p><b>Transmission:</b> Manual</p>
								<p><b>Features:</b> Central locking, Driver airbag, Passenger airbag</p>
								
								<br />
								<form action="smart_confirm.jsp" method = "get">
								<label>Color:</label>
								<select name ="color">
