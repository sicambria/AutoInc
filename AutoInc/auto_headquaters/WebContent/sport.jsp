...
<head>
    ...
    <title>Product Details | Sport Car</title>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="images/home/products/sport_long.jpg" alt="" />
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h2>Sport</h2>
								<span>
									<span>US $25,000</span><br/>
									<span><h5>+3,500 for comfort edition</h5></span><br/>
								</span>
								
								<p><b>Engine:</b> 6 cylinder, 3984cc</p>
								<p><b>Transmission:</b> Manual</p>
								<p><b>Features:</b> ABS brakes, Alarms, Alloy wheels, Central locking,
													Driver airbag, Passenger airbag, Power steering, Towbar</p>
								
								<br />
								<form action="sport_confirm.jsp" method = "get">
								<label>Color:</label>
								<select name ="color">
