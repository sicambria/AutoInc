 ...
 */
            ...
            /**
            *  CancelResupplyOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancelResupplyOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":cancelResupplyOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "cancelResupplyOperation",
    ...
    public static class Factory{
        ...
        */
        public static CancelResupplyOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelResupplyOperation object =
                new CancelResupplyOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cancelResupplyOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelResupplyOperation)com.autoinc.resupply.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
