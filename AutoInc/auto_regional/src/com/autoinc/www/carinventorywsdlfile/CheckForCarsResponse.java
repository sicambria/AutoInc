 ...
 */
            ...
            /**
            *  CheckForCarsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckForCarsResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.autoinc.com/CarInventoryWSDLFile/",
                "checkForCarsResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":checkForCarsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "checkForCarsResponse",
    ...
    public static class Factory{
        ...
        */
        public static CheckForCarsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckForCarsResponse object =
                new CheckForCarsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkForCarsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckForCarsResponse)com.autoinc.www.carinventorywsdlfile.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
